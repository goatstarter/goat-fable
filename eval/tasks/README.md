...
Eight behavior traps. Each file: how to instantiate it in YOUR repo, the exact prompt, the hidden check you run afterwards, and what good/failed runs look like.
